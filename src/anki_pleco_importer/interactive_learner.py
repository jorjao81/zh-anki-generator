...
class InteractiveLearner:
    ...
    def process_classified_words(self, classifications: List[WordClassification]) -> LearningSession:
        ...
        learning_candidates = [c for c in classifications if c.classification in ["worth_learning", "compositional"]]
        ...
        click.echo(
            "\033[90mFor each word, press: \033[92m[y]\033[90mes to learn, \033[91m[n]\033[90mo to skip, \033[93m[q]\033[90muit\033[0m"
        )
        ...
        for i, classification in enumerate(learning_candidates, 1):
            ...
            while True:
                click.echo(
                    "\n\033[90mLearn this word? \033[92m[y]\033[90m/\033[91m[n]\033[90m/\033[93m[q]\033[90m: \033[0m",
                    nl=False,
                )
...
def create_interactive_learner(
    names_file: Optional[Path] = None, known_words_file: Optional[Path] = None
) -> InteractiveLearner:
